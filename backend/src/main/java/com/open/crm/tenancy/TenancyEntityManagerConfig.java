...
/**
 * Configuration for tenant-specific entities (Client, etc.) These entities use multi-tenancy and
 * reside in tenant-specific schemas
 */
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(
    basePackages = "com.open.crm.core",
