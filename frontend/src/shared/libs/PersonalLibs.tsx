...
const PersonalLibs = Object.freeze({
    getFullname: (data: { firstname?: string; lastname?: string; patronymic?: string }) => {
        let fullname = "";
    ...
    getInitials: (data: { firstname?: string; lastname?: string; patronymic?: string }) => {
        let initials = "";
    ...
    getShortName: (data: { firstname?: string; lastname?: string, patronymic?: string }) => {
        let shortName = "";
