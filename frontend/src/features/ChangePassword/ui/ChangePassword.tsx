...
const ChangePassword = () => {
  ...
  const [getPasswordLevel, { data: passwordLevel, reset: resetPasswordLevel }] =
    useGetPasswordLevel();
  ...
  }, [newPassword, resetPasswordLevel, getPasswordLevel]);
  ...
  return (
    ...
    >
      ...
      {isError && <Text color="error.main">{errorMessage}</Text>}
